      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
            ...
            <div className="flex flex-col">
              ...
              {userRole === 'customer' && (
                <button 
                  ...
                  className="hidden sm:flex items-center text-xs text-gray-500 dark:text-gray-400 mt-0.5 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors text-left group"
                >
                  <MapPin className="w-3 h-3 mr-1 shrink-0 group-hover:text-emerald-500" />
                  <span className="truncate max-w-[150px] sm:max-w-[200px]">Delivery to <strong className="dark:text-gray-200">{address}</strong></span>
                </button>
              )}
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            {userRole === 'customer' && (
              <>
                <button className="p-2 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full md:hidden">
